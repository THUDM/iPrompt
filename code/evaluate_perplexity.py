...
def set_args():
    ...
    args.load = "/data1/checkpoints/txl-2.8b11-20-15-10"
...
def generate(fname):
    ...
    for line in w:
        ...
        print("sample:", sumsample, " score:", score , " avg score:", sumscore,"perplexity:",torch.exp(score/len(text_str))," average perplexity:",torch.exp(sumscore/total_length) )
